...
class ModulesActivity : AppCompatActivity() {
    ...
    private fun home(){val r=root("H2pro");r.addView(label("مركز الوحدات المحاسبية",18f,true),margin());r.addView(button("تهيئة النظام"){startActivity(Intent(this,SystemSetupActivity::class.java))},margin());r.addView(button("إدارة النظام"){startActivity(Intent(this,SystemAdminActivity::class.java))},margin());r.addView(button("إدارة الأستاذ العام"){startActivity(Intent(this,GeneralLedgerActivity::class.java))},margin());r.addView(button("إدارة المخزون"){startActivity(Intent(this,InventoryActivity::class.java))},margin());r.addView(button("إدارة المشتريات"){startActivity(Intent(this,PurchaseActivity::class.java))},margin());r.addView(button("فاتورة شراء متعددة الأصناف"){startActivity(Intent(this,MultiInvoiceActivity::class.java).putExtra("kind","شراء"))},margin());r.addView(button("إدارة المبيعات"){startActivity(Intent(this,SalesActivity::class.java))},margin());r.addView(button("فاتورة بيع متعددة الأصناف"){startActivity(Intent(this,MultiInvoiceActivity::class.java).putExtra("kind","بيع"))},margin());r.addView(button("المرتجعات"){startActivity(Intent(this,ReturnsActivity::class.java))},margin());r.addView(button("التقارير المالية"){startActivity(Intent(this,FinancialReportsActivity::class.java))},margin());r.addView(button("أنظمة وتقارير مساعدة"){show("أنظمة وتقارير مساعدة",listOf("ميزان المراجعة","قائمة الدخل","الكشوفات","سجل العمليات","تقارير عامة"))},margin());setContentView(ScrollView(this).apply{addView(r,ViewGroup.LayoutParams(-1,-1))})}
